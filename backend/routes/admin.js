...
router.delete('/users/:id', (req, res) => {
  ...
  db.prepare('UPDATE invites SET created_by = NULL WHERE created_by = ?').run(req.params.id);
  db.prepare('UPDATE invites SET used_by = NULL WHERE used_by = ?').run(req.params.id);
