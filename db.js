...
function initDb() {
  ...
  const migrations = [
    'ALTER TABLE users ADD COLUMN storage_quota INTEGER DEFAULT 2147483648',
  ...
  db.prepare("INSERT OR IGNORE INTO settings (key, value) VALUES ('default_quota', '2147483648')").run();
